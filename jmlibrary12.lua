...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://88954689974240" --背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://74382335198605"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://74382335198605" or "rbxassetid://74382335198605" --开关的图
end)
